...
public record VectorSearchSettings(string IndexName, int DocumentCount, string EmbeddingFieldName, string EmbeddingModelName, int MaxSourceTokens, int KNearestNeighborsCount, bool Exhaustive, bool UseSemanticRanker, string SemanticConfigurationName, string SourceContainer, bool CitationUseSourcePage);
